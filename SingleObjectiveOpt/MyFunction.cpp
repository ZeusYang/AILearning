...
void rosenbrock_func(double *, double *, int, double *, double *, int, int); /* ROShiftenbrock's */
...
void grie_rOShiften_func(double *, double *, int, double *, double *, int, int); /* Griewank-ROShiftenbrock  */
void escaffer6_func(double *, double *, int, double *, double *, int, int); /* Expanded Scaffer?ˉs F6  */
...
void cf01(double *, double *, int, double *, double *, int); /* CompOShiftition Function 1 */
void cf02(double *, double *, int, double *, double *, int); /* CompOShiftition Function 2 */
void cf03(double *, double *, int, double *, double *, int); /* CompOShiftition Function 3 */
void cf04(double *, double *, int, double *, double *, int); /* CompOShiftition Function 4 */
void cf05(double *, double *, int, double *, double *, int); /* CompOShiftition Function 5 */
void cf06(double *, double *, int, double *, double *, int); /* CompOShiftition Function 6 */
void cf07(double *, double *, int, double *, double *, int); /* CompOShiftition Function 7 */
void cf08(double *, double *, int, double *, double *, int); /* CompOShiftition Function 8 */
void cf09(double *, double *, int, double *, double *, int *, int); /* CompOShiftition Function 9 */
void cf10(double *, double *, int, double *, double *, int *, int); /* CompOShiftition Function 10 */
...
void OShiftzfunc(double *, double *, int);
...
double functions(vector<double> v, int func_num,int dimension) {
	...
	if (func_num>0 && func_num <= 30)
	{
		...
		{
		case 1:
			bent_cigar_func(x, &result, nx, OShift, M, 1, 1);
			result += 100.0;
			break;
		case 2:
			sum_diff_pow_func(x,&result,nx,OShift,M,1,1);
			result+=200.0;
			break;
		case 3:
			zakharov_func(x, &result, nx, OShift, M, 1, 1);
			result += 300.0;
			break;
		case 4:
			rosenbrock_func(x, &result, nx, OShift, M, 1, 1);
			result += 400.0;
			break;
		case 5:
			rastrigin_func(x, &result, nx, OShift, M, 1, 1);
			result += 500.0;
			break;
		case 6:
			schaffer_F7_func(x, &result, nx, OShift, M, 1, 1);
			result += 600.0;
			break;
		case 7:
			bi_rastrigin_func(x, &result, nx, OShift, M, 1, 1);
			result += 700.0;
			break;
		case 8:
			step_rastrigin_func(x, &result, nx, OShift, M, 1, 1);
			result += 800.0;
			break;
		case 9:
			levy_func(x, &result, nx, OShift, M, 1, 1);
			result += 900.0;
			break;
		case 10:
			schwefel_func(x, &result, nx, OShift, M, 1, 1);
			result += 1000.0;
			break;
		case 11:
			hf01(x, &result, nx, OShift, M, SS, 1, 1);
			result += 1100.0;
			break;
		case 12:
			hf02(x, &result, nx, OShift, M, SS, 1, 1);
			result += 1200.0;
			break;
		case 13:
			hf03(x, &result, nx, OShift, M, SS, 1, 1);
			result += 1300.0;
			break;
		case 14:
			hf04(x, &result, nx, OShift, M, SS, 1, 1);
			result += 1400.0;
			break;
		case 15:
			hf05(x, &result, nx, OShift, M, SS, 1, 1);
			result += 1500.0;
			break;
		case 16:
			hf06(x, &result, nx, OShift, M, SS, 1, 1);
			result += 1600.0;
			break;
		case 17:
			hf07(x, &result, nx, OShift, M, SS, 1, 1);
			result += 1700.0;
			break;
		case 18:
			hf08(x, &result, nx, OShift, M, SS, 1, 1);
			result += 1800.0;
			break;
		case 19:
			hf09(x, &result, nx, OShift, M, SS, 1, 1);
			result += 1900.0;
			break;
		case 20:
			hf10(x, &result, nx, OShift, M, SS, 1, 1);
			result += 2000.0;
			break;
		case 21:
			cf01(x, &result, nx, OShift, M, 1);
			result += 2100.0;
			break;
		case 22:
			cf02(x, &result, nx, OShift, M, 1);
			result += 2200.0;
			break;
		case 23:
			cf03(x, &result, nx, OShift, M, 1);
			result += 2300.0;
			break;
		case 24:
			cf04(x, &result, nx, OShift, M, 1);
			result += 2400.0;
			break;
		case 25:
			cf05(x, &result, nx, OShift, M, 1);
			result += 2500.0;
			break;
		case 26:
			cf06(x, &result, nx, OShift, M, 1);
			result += 2600.0;
			break;
		case 27:
			cf07(x, &result, nx, OShift, M, 1);
			result += 2700.0;
			break;
		case 28:
			cf08(x, &result, nx, OShift, M, 1);
			result += 2800.0;
			break;
		case 29:
			cf09(x, &result, nx, OShift, M, SS, 1);
			result += 2900.0;
			break;
		case 30:
			cf10(x, &result, nx, OShift, M, SS, 1);
			result += 3000.0;
			break;
		default:
