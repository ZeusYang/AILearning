...
//            std::cout << "OShife->" << OShift[i] << std::endl;
//        }
//    }
//    else
//    {
...
//    func_flag = func_num;
//    ini_flag = 1;
//    std::cout << std::endl << OShift[0] << " ******* " << OShift[1] << std::endl;
//    cout << "initialization sucess!" << endl;
//}

//double function(vector<double> v,int func_num,int dimension) {
