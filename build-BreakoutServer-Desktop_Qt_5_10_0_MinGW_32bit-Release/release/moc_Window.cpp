...
#include "../../BreakoutServer/Window.h"
...
QT_MOC_LITERAL(7, 42, 7), // "sendMsg"
QT_MOC_LITERAL(8, 50, 14), // "showConnection"
QT_MOC_LITERAL(9, 65, 17), // "showDisconnection"
QT_MOC_LITERAL(10, 83, 16) // "socketDescriptor"

    },
    "Window\0sendData\0\0data\0id\0revData\0"
    "peerHost\0sendMsg\0showConnection\0"
    "showDisconnection\0socketDescriptor"
};
...
void Window::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 3: _t->showConnection(); break;
        case 4: _t->showDisconnection((*reinterpret_cast< int(*)>(_a[1]))); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            typedef void (Window::*_t)(QByteArray , int );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Window::sendData)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void Window::sendData(QByteArray _t1, int _t2)
{
